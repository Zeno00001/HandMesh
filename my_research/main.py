...
from my_research.runner import Runner
...
def main(args):
    ...
    # from my_research.datasets.multipledatasets import MultipleDatasets
    exec('from my_research.datasets.{} import {}'.format(cfg.TRAIN.DATASET.lower(), cfg.TRAIN.DATASET))

    # from my_research.datasets.ge import Ge
    exec('from my_research.datasets.{} import {}'.format(cfg.VAL.DATASET.lower(), cfg.VAL.DATASET))
