...
_C.DATA.FRAME_COUNTS = 8  # for sequencial data
...
_C.DATA.HANCO_EVAL = CN()
_C.DATA.HANCO_EVAL.USE = True
_C.DATA.HANCO_EVAL.ROOT = 'data/HanCo'
_C.DATA.HANCO_EVAL.ROT = 0
_C.DATA.HANCO_EVAL.SCALE = 0.2
_C.DATA.HANCO_EVAL.BASE_SCALE = 1.3
_C.DATA.HANCO_EVAL.FLIP = False

_C.DATA.FREIHAND_ANGLE = CN()
_C.DATA.FREIHAND_ANGLE.USE = True
_C.DATA.FREIHAND_ANGLE.ROOT = 'data/FreiHAND'
_C.DATA.FREIHAND_ANGLE.ROT = 90
_C.DATA.FREIHAND_ANGLE.SCALE = 0.2
_C.DATA.FREIHAND_ANGLE.BASE_SCALE = 1.3
_C.DATA.FREIHAND_ANGLE.FLIP = False
